...
public class RecyclerViewPlayers {
                ...
                itemView.setOnClickListener( new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       if(role.getText().toString()=="none")
                       {
                          switch (TeamSelection.radioGroup.getCheckedRadioButtonId())
                          {
                              case R.id.teambutton:
                              {
                                  ...
                                  Team1.t1.get(key-1).setTit("Player");
                                    break;
                              ...
                              case R.id.vicecaptain:
                                  ...
                                  else
                                  {
                                      ...
                                      Team1.t1.get(key-1).setTit("Vice Captain");
                                      break;
                              ...
                              case R.id.captainbutton:
                                  ...
                                  else
                                  {
                                      ...
                                      Team1.t1.get(key-1).setTit("Captain");
                                      break;
                       ...
                       else
                       {
                           ...
                           Team1.t1.get(key-1).setTit("none");
                       }
